...
/**
 * This is a customized version of Minion_CLI for use with this module only
 * while Minion continues active development. It adds: 
 *
 * - Support for colorization on Windows with the ANSICON console
 * - Ability to configure STDIN and STDOUT for testing
 *
...
class Kohana_Minion_CLI
{
	...
	public static function supports_ansi()
	{
		...
		return (function_exists('posix_isatty') AND @posix_isatty(Minion_CLI::$_stdout));
	}
