...
This creates all the files you need, starting with classes/Bar/Generator/Type/Foo.php with some skelton methods for you to work with, and a stub for transparent extension. It also adds unit test and task files for the new type. So now would be a good time to read about [Running the Tasks](tasks).
